 ...
 **********************************************************************************************************************/
 ...
 Window *New_Window_Default(char *id, bool main_Window){
     ...
     windowInfos->width = 700;
     windowInfos->height = 500;
     ...
     windowInfos->opacity = 1;

     // set the default resizable
     gtk_window_set_resizable(GTK_WINDOW(window), TRUE);
     windowInfos->resizable = TRUE;

     // set the default decorated
     gtk_window_set_decorated(GTK_WINDOW(window), TRUE);
     windowInfos->decorated = TRUE;

     // set the default modal
     gtk_window_set_modal(GTK_WINDOW(window), TRUE);
     windowInfos->modal = TRUE;

     // set the default deletable
     gtk_window_set_deletable(GTK_WINDOW(window), TRUE);
     windowInfos->deletable = TRUE;

     // set the default full screen
     gtk_window_unfullscreen(GTK_WINDOW(window));
     windowInfos->full_Screen = FALSE;
     ...
     gtk_window_set_position(GTK_WINDOW(window), center);
